...
const HomeBanner = () => {
    return (
        ...
        <div className="bg-cyan-700 w-full linear-gradient(90.21deg, rgba(72, 19, 146) -5.91%, rgb(31, 4, 69) 111.58%); py-16 px-4 h-600">
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-2 gap-10">
                <FadeIn delay={0.3} direction={"left"}>
                    <div className=" flex flex-col justify-center ml-14">
                        ...
                        <Link to="/login">
                        <button
                            className=" bg-orange-400 mt-10 w-40 text-white border-radius-5 rounded-lg p-3"
